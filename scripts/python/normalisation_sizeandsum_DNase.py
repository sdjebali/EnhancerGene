#Normalize each cell by the column sum and the size of the interval.
...
print("\t".join(header)[:-1])
for line in output:
    line.small_intestine = (int(line.small_intestine)/small_intestine * 1000000)/(int(line.end)-int(line.start))*1000
    line.adrenal_gland = (int(line.adrenal_gland)/adrenal_gland * 1000000)/(int(line.end)-int(line.start))*1000
    line.HepG2 = (int(line.HepG2)/HepG2 * 1000000)/(int(line.end)-int(line.start))*1000
    line.stomach = (int(line.stomach)/stomach * 1000000)/(int(line.end)-int(line.start))*1000
    line.heart = (int(line.heart)/heart * 1000000)/(int(line.end)-int(line.start))*1000
    line.thymus = (int(line.thymus)/thymus * 1000000)/(int(line.end)-int(line.start))*1000
    line.K562 = (int(line.K562)/K562 * 1000000)/(int(line.end)-int(line.start))*1000
    line.GM12878 = (int(line.GM12878)/GM12878 * 1000000)/(int(line.end)-int(line.start))*1000
    line.H1_hESC = (int(line.H1_hESC)/H1_hESC * 1000000)/(int(line.end)-int(line.start))*1000
    line.IMR_90 = (int(line.IMR_90)/IMR_90 * 1000000)/(int(line.end)-int(line.start))*1000
    print(line)
